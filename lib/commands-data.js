...
export const commands = [
  ...
  },
  {
    ...
    description: "Open your inventory directly from the command line.",
    example: "/inventory",
    aliases: [],
    category: "Utility",
    anchor: "utility-commands",
  ...
  },
  {
    ...
    description: "Print your X, Y, and Z coordinates into the chat window.",
    example: "/loc_vec",
    aliases: [],
    category: "Utility",
    note: "Developer trick",
    noteText: "Useful when documenting locations or testing map positions.",
    anchor: "utility-commands",
    letter: "L"
  },
  {
    id: "max-fps",
    syntax: "/maxfps <integer>",
    title: "Set Max FPS",
    description: "Change the maximum frame rate limit. Use 0 to return to automatic behavior.",
    example: "/maxfps 60",
    aliases: [],
    category: "Display",
    anchor: "display-commands",
  ...
  },
  {
    ...
    syntax: "/roll",
    title: "Roll",
    description: "Trigger the roll command when supported by the client.",
    example: "/roll",
    aliases: [],
    category: "Utility",
    note: "Undocumented",
    noteText: "Public descriptions for this command remain limited.",
    anchor: "undocumented",
    letter: "R"
  },
  {
    ...
    description: "Change the game window to a specific width and height.",
    example: "/screen 1920 1080",
    aliases: [],
    category: "Display",
    anchor: "display-commands",
    letter: "S"
  ...
  {
    id: "screenshot-ui-jpg",
    syntax: "/screenshot_ui_jpg",
    title: "Take a Screenshot With UI",
    description: "Save a JPG screenshot including the user interface.",
    example: "/screenshot_ui_jpg",
    aliases: [],
    category: "Display",
    anchor: "display-commands",
    letter: "S"
  ...
  {
    id: "target-cursor-autoattack",
    syntax: "/targetCursorOrAutoAttack",
    title: "Target Cursor Or Auto Attack",
    description: "Change the targeting method to include auto attack together with target cursor behavior.",
    example: "/targetCursorOrAutoAttack",
    aliases: [],
    category: "Utility",
    anchor: "utility-commands",
    letter: "T"
  },
  {
    ...
    syntax: "/walk 1|0",
    title: "Toggle Walk",
    description: "Switch between normal movement and slow walk mode, including while mounted.",
    example: "/walk 1",
    aliases: [],
    category: "Utility",
    anchor: "utility-commands",
...
export const categoryPageContent = {
  home: {
    ...
    intro:
      "A fan-made command manual for Neverwinter players who want clean syntax, clearer explanations, and faster lookup across chat, emotes, utility commands, and common troubleshooting tools."
  },
  categories: {
    title: "Browse Neverwinter Command Categories",
    intro:
      "Explore command groups by player intent, including chat, private messages, party and guild coordination, utility actions, emotes, and display settings."
  },
  emotes: {
    title: "Neverwinter Emotes",
    intro:
      "Browse Neverwinter emote commands with quick explanations, aliases, and examples for roleplay, greetings, reactions, and social scenes."
  },
  utility: {
    title: "Neverwinter Utility Commands",
    intro:
      "Find utility, display, and troubleshooting commands for screenshots, combat logging, movement recovery, performance checks, and interface behavior."
  }
};

export function slugifyCommand(command) {
  return command.id;
}

export function getCommandUrl(command) {
  return `/commands/${slugifyCommand(command)}`;
}
...
export function getCommandBySlug(slug) {
  return commands.find((command) => slugifyCommand(command) === slug);
}

export function getCommandsByCategory(category) {
  if (category === "Utility") {
    return commands.filter((command) => ["Utility", "Display"].includes(command.category));
  }

  if (category === "Emotes") {
    return commands.filter((command) => command.category === "Emotes");
  }
